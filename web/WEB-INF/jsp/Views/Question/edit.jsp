                        ...
                        <div class="col-lg-6">                        
                            ...
                            <div class="mb-3" >
                                <div class="form-check mb-2 form-check-success">
                                    ...
                                    <textarea id="answer1" name="answer" class="form-control" id="example-textarea" rows="4">${pos0.note}</textarea>
                            ...
                            <div class="mb-3" >
                                ...
                                <textarea id="answer2" name="answer" class="form-control" id="example-textarea" rows="4">${pos1.note}</textarea>
                            ...
                            <div class="mb-3" >
                                ...
                                <textarea id="answer3" name="answer" class="form-control" id="example-textarea" rows="4">${pos2.note}</textarea>
                            ...
                            <div class="mb-3" >
                                ...
                                <textarea id="answer4" name="answer" class="form-control" id="example-textarea" rows="4">${pos3.note}</textarea>
